...
class QBittorrentDialogs {
  QBittorrentDialogs._();
  ...
  static Future<List<dynamic>> defaultPage(BuildContext context) async {
    ...
    await LunaDialog.dialog(
      ...
      title: 'Page',
      content: List.generate(
        QBittorrentNavigationBar.titles.length,
        (index) => LunaDialog.tile(
          text: QBittorrentNavigationBar.titles[index],
          icon: QBittorrentNavigationBar.icons[index],
          iconColor: LunaColours().byListIndex(index),
